...
class Config:
    ...
    telegram_chat_id: Optional[str] = None  # Chat ID（群聊一般是 -100...）
    telegram_message_thread_id: Optional[int] = None  # 论坛群 Topics 的 thread id（可选）
    ...
    def _load_from_env(cls) -> 'Config':
        ...
        return cls(
            ...
            telegram_message_thread_id=(
                int(os.getenv('TELEGRAM_MESSAGE_THREAD_ID'))
                if (os.getenv('TELEGRAM_MESSAGE_THREAD_ID') or '').strip() else None
            ),
